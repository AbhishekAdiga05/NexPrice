...
export default function SetPriceAlert({ productId, currentPrice, currency, alerts }) {
      ...
      <div className="flex items-center gap-2 mb-3">
        ...
        <form onSubmit={handleSet} className="flex items-center gap-2">
          ...
          <Button
            ...
            className="h-10 px-5 gap-1.5 font-bold"
          >
            {submitting ? (
  ...
  return (
    <div className="border-t border-white/[0.06] pt-4">
      ...
      {activeAlert && (
        <div className="rounded-lg border border-indigo-500/20 bg-indigo-500/[0.06] p-4">
          <div className="flex items-center justify-between gap-3">
            <div className="flex items-center gap-3 min-w-0">
              <div className="size-9 rounded-full bg-indigo-500/[0.12] flex items-center justify-center shrink-0">
            ...
            <button
              ...
              className="shrink-0 size-8 rounded-full flex items-center justify-center text-indigo-400 hover:bg-indigo-500/[0.12] hover:text-indigo-300 transition-colors"
              title="Remove alert"
            >
          ...
          {current > parseFloat(activeAlert.target_price) && (
            <>
              <div className="mt-3 h-1.5 rounded-full bg-indigo-500/[0.12] overflow-hidden">
                <div
              ...
              <div className="flex justify-between mt-1 text-[10px] text-indigo-400/70 font-mono">
        ...
        <div className="mt-3">
          ...
          <div className="flex flex-wrap gap-2">
            {triggeredAlerts.map((alert) => (
              <div
                key={alert.id}
                className="inline-flex items-center gap-1.5 rounded-full border border-emerald-500/30 bg-emerald-500/[0.08] px-3 py-1"
              >
